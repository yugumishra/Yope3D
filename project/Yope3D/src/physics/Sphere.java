...
public class Sphere extends Mesh {
	...
	//also mass bc physics
	private float mass;
	
	//also moment of inertia bc physics
	private float moi;
	...
	public void setMass(float n) {
		mass = n;
		moi = 0.4f * radius * radius * n;
	}
	
	//public constructor that creates mesh and indices based on input
	public static Sphere genSphere(int subdiv, float radius) {
